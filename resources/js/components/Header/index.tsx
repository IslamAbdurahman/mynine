...
const Header: React.FC = () => {
    ...
    return (
        <header
            className={`fixed top-0 z-40 w-full transition-all duration-300 ${sticky ? 'bg-white/80 dark:bg-gray-950/80 backdrop-blur-md py-4 shadow-lg' : 'bg-transparent py-5 shadow-none'}`}
        >
