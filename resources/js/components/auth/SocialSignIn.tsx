...
const SocialSignIn = () => {
    ...
    const signIn = (provider: string) => {
        ...
        // For Telegram, the login is via widget, so do nothing on button click
        if (provider === 'telegram') {
            // Scroll to Telegram widget or focus it if needed
    ...
    return (
        <>
            ...
            <div id="telegram-container" className="mt-4"></div>
        </>
    );
};
